...
namespace TestApp
{
    public class Helper
    {
        ...
        public static string CalculateBamFromEur(string euros)
        {
            return (Convert.ToInt32(euros) * 1.95583) + "";
        }

        public static bool IsCorrect(string mail, string password)
        {
            return mail == "test@abc.com" && password == "test1234";
        }

        public static string CalculatePDV(string amount)
        {
            return (Convert.ToInt32(amount) * 0.17) + "";
        }

        public static string CalculateRate(string amount, string rates)
        {
            return (Convert.ToInt32(amount) / Convert.ToInt32(rates)) + "";
        }

        public static string CalculateAverage(string numbers)
        {
            int sum = 0;
            int count = 1;
